"""
Code adapted from https://github.com/facebookresearch/dadaptation
"""
...
class DAdaptAdam(torch.optim.Optimizer):
    ...
    def step(self, closure=None):
        ...
        if log_every > 0 and k % log_every == 0:
            print(f"\tlr: {lr} dlr: {dlr} d_hat: {d_hat}, d: {d}. sk_l1={global_sk_l1:1.1e} numerator_weighted={global_numerator_weighted:1.1e}")
